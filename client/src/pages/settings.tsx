...
import { User, Globe, CreditCard, Shield, ExternalLink, Loader2, RefreshCw, Smartphone, Star } from "lucide-react";
                ...
                <div className="relative p-4 rounded-lg border-2 border-primary/40 bg-primary/10 hover-elevate">
                  ...
                  <div className="flex items-start gap-3 mb-3 mt-2">
                    ...
                    <div className="flex-1">
                      <p className="font-semibold text-base">{t.settings.cardSubscription}</p>
                      <p className="text-sm text-muted-foreground mt-1">{t.settings.cardSubscriptionDesc}</p>
                    </div>
                  </div>
