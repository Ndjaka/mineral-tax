...
const translations = {
  fr: {
    ...
    step3Desc: "Le taux officiel OFDF varie selon le secteur : 60.05 CHF/100L pour l'agriculture (plaques vertes, paiements directs) dès le 01.01.2026 (+76%), et 34.06 CHF/100L pour le BTP et autres secteurs. Visualisez en temps réel le montant de votre remboursement potentiel.",
    step3Features: ["Taux OFDF 60.05 CHF/100L (Agriculture 2026)", "Taux OFDF 34.06 CHF/100L (BTP/Autres)", "Calcul instantané", "Tableau de bord en temps réel"],
    ...
    step5Desc: "Dès mai 2026, l'utilisation du portail Taxas est obligatoire. Connectez-vous au portail ePortal/Agate de l'OFDF et importez votre fichier CSV généré par MineralTax.",
    step5Features: ["Virage numérique : Taxas obligatoire", "Compatible norme Stat. 2710", "Support multilingue"],
    ...
    rateValue: "34.06 - 60.05 CHF/100L",
    eligible: "Éligible",
  ...
  de: {
    ...
    step3Desc: "Der offizielle BAZG-Satz variiert je nach Sektor : 60.05 CHF/100L für die Landwirtschaft (grüne Kennzeichen, Direktzahlungen) ab dem 01.01.2026 (+76%), und 34.06 CHF/100L für Bau und andere Sektoren. Sehen Sie in Echtzeit Ihre potenzielle Rückerstattung.",
    step3Features: ["BAZG-Satz 60.05 CHF/100L (Landwirtschaft 2026)", "BAZG-Satz 34.06 CHF/100L (Bau/Andere)", "Sofortige Berechnung", "Echtzeit-Dashboard"],
    ...
    step5Desc: "Ab Mai 2026 ist die Nutzung des Taxas-Portals obligatorisch. Melden Sie sich beim ePortal/Agate-Portal des BAZG an und importieren Sie Ihre von MineralTax generierte CSV-Datei.",
    step5Features: ["Digitaler Wandel: Taxas obligatorisch", "Kompatibel mit Stat. 2710", "Mehrsprachige Unterstützung"],
  ...
  it: {
    ...
    step3Desc: "L'aliquota ufficiale AFD varia secondo il settore: 60.05 CHF/100L per l'agricoltura (targhe verdi, pagamenti diretti) dal 01.01.2026 (+76%), e 34.06 CHF/100L per l'edilizia e altri settori. Visualizza in tempo reale il tuo potenziale rimborso.",
    step3Features: ["Aliquota AFD 60.05 CHF/100L (Agricoltura 2026)", "Aliquota AFD 34.06 CHF/100L (Edilizia/Altri)", "Calcolo istantaneo", "Dashboard in tempo reale"],
    ...
    step5Desc: "Da maggio 2026, l'uso del portale Taxas è obbligatorio. Accedi al portale ePortal/Agate dell'AFD e importa il tuo file CSV generato da MineralTax.",
    step5Features: ["Svolta digitale: Taxas obbligatorio", "Compatibile norma Stat. 2710", "Supporto multilingue"],
  ...
  en: {
    ...
    step3Desc: "The official FOCBS rate varies by sector: 60.05 CHF/100L for agriculture (green license plates, direct payments) from 01.01.2026 (+76%), and 34.06 CHF/100L for construction and other sectors. See your potential reimbursement in real-time.",
    step3Features: ["FOCBS rate 60.05 CHF/100L (Agriculture 2026)", "FOCBS rate 34.06 CHF/100L (Construction/Others)", "Instant calculation", "Real-time dashboard"],
    ...
    step5Desc: "From May 2026, using the Taxas portal is mandatory. Log in to the FOCBS ePortal/Agate portal and import your CSV file generated by MineralTax.",
    step5Features: ["Digital shift: Mandatory Taxas", "Stat. 2710 standard compatible", "Multilingual support"],
