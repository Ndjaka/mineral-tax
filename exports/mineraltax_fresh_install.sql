...
-- VERSION INSTALLATION FRAÎCHE
-- (pour base de données vide/nouvelle)
-- Date: 2026-01-17
-- ============================================
-- ATTENTION: Ce fichier suppose une base de données VIDE.
-- N'exécutez pas sur une base existante avec des données MineralTax.
-- ============================================
