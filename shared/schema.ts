...
// Note: Les agriculteurs bénéficient en plus de la redistribution de la taxe CO2 (calculée selon masse salariale AVS)
export const REIMBURSEMENT_RATE_CHF_PER_LITER = 0.3405; // 34.05 CHF/100L

// Date de transition (pour référence historique uniquement)
...
export function getApplicableRate(
  ...
  return REIMBURSEMENT_RATE_CHF_PER_LITER;
}
