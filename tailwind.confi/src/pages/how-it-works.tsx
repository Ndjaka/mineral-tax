...
const translations = {
  fr: {
    ...
    step3Desc: "Le taux officiel OFDF de 0.3405 CHF/L est appliqué automatiquement. Visualisez en temps réel le montant de votre remboursement potentiel.",
    step3Features: ["Taux OFDF 0.3405 CHF/L", "Calcul instantané", "Tableau de bord en temps réel"],
    step4Title: "Générez votre rapport",
    step4Desc: "Créez un rapport PDF conforme au formulaire officiel 45.35. Exportez également un fichier CSV compatible avec la plateforme Taxas.",
    step4Features: ["PDF conforme 45.35", "Export CSV Taxas", "Audit de conformité intégré"],
  ...
  de: {
    ...
    step3Desc: "Der offizielle BAZG-Satz von 0.3405 CHF/L wird automatisch angewendet. Sehen Sie in Echtzeit Ihre potenzielle Rückerstattung.",
    step3Features: ["BAZG-Satz 0.3405 CHF/L", "Sofortige Berechnung", "Echtzeit-Dashboard"],
    step4Title: "Generieren Sie Ihren Bericht",
    step4Desc: "Erstellen Sie einen PDF-Bericht konform mit dem offiziellen Formular 45.35. Exportieren Sie auch eine CSV-Datei für die Taxas-Plattform.",
    step4Features: ["PDF konform 45.35", "CSV-Export Taxas", "Integrierte Konformitätsprüfung"],
  ...
  it: {
    ...
    step3Desc: "L'aliquota ufficiale AFD di 0.3405 CHF/L viene applicata automaticamente. Visualizza in tempo reale il tuo potenziale rimborso.",
    step3Features: ["Aliquota AFD 0.3405 CHF/L", "Calcolo istantaneo", "Dashboard in tempo reale"],
    step4Title: "Genera il tuo rapporto",
    step4Desc: "Crea un rapporto PDF conforme al modulo ufficiale 45.35. Esporta anche un file CSV compatibile con la piattaforma Taxas.",
    step4Features: ["PDF conforme 45.35", "Export CSV Taxas", "Audit di conformità integrato"],
  ...
  en: {
    ...
    step3Desc: "The official FOCBS rate of 0.3405 CHF/L is automatically applied. See your potential reimbursement in real-time.",
    step3Features: ["FOCBS rate 0.3405 CHF/L", "Instant calculation", "Real-time dashboard"],
    step4Title: "Generate your report",
    step4Desc: "Create a PDF report compliant with official form 45.35. Also export a CSV file compatible with the Taxas platform.",
    step4Features: ["PDF compliant 45.35", "CSV export Taxas", "Built-in compliance audit"],
